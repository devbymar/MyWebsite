<template>
  <section id="hero" :class="[
    ...
    <main class="relative z-10 flex flex-col lg:flex-row justify-between items-center w-full max-w-7xl p-4 lg:p-12">
      ...
      <aside class="container flex justify-center lg:justify-end mt-12 lg:mt-0 flex-1">
        <figure :class="[
          ...
          <div class="relative w-full h-full bg-cover transform translate-x-[25px] translate-y-[30px]">
